...
<body>
    ...
    <div>
        <p>
            ...
            <asp:Label ID="Label3" runat="server" Text= "Enter a License Number"></asp:Label>
            <asp:TextBox ID="txtLicense" runat="server"></asp:TextBox><br/>

            <asp:Label ID="Label4" runat="server" Text= "Enter Make"></asp:Label>
            <asp:TextBox ID="txtMake" runat="server"></asp:TextBox><br/>

            <asp:Label ID="Label5" runat="server" Text= "Enter Vehicle Year"></asp:Label>
